...
export default function Votes(props: {upvotes: number, downvotes: number}){
    const [upvoted, setUpvoted] = useState(false);
    const [downvoted, setDownvoted] = useState(false);
    const [upvoteFill, setUpvoteFill] = useState("#000000");
    const [downvoteFill, setDownvoteFill] = useState("#000000");
    ...
    return(
        ...
        >
            ...
            <p className="text-md font-rubik" style={{cursor:"default"}}>{props.upvotes - props.downvotes}</p>
