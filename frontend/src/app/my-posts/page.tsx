...
export default function Page() {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      ...
      console.log(
        "Unique IDs:",
        new Set(postData.map((post: Post) => post.id)).size
      );
  ...
  return (
    <div className="w-full place-self-start mt-8">
      <AnimatePresence>
        {noPosts && (
          <motion.div className="flex flex-col justify-center place-self-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <motion.p
